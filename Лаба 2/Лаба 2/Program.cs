...
namespace Лаба_2
{
    ...
    class Machine
    {
        ...
        public void Run(string str)
        {
            ...
            int temp = 0;
            Console.WriteLine(ShowHead(0, str.Length + 1, temp));
            Console.WriteLine(ShowString(0, str.Length + 1));
            Console.WriteLine("");
            while (State != -1)
            {

                Transition transition = _transitionMatrix.GetRow(tape[Head], State);
                Console.WriteLine(Convert.ToString(transition.move)+"\t"+ "S:"+transition.newState+"\t"+ transition.replacement);
                Console.WriteLine("");
                Console.WriteLine("\t  S:0");
                Console.Write("0"); Console.WriteLine("\t 1>S:0");
                Console.WriteLine("1\t 0>S:0");
                Console.WriteLine("_\t _>S:-1");
                ...
                Console.WriteLine(ShowHead(0, str.Length + 1, temp + 1));
                Console.WriteLine(ShowString(0, str.Length + 1));
                Console.WriteLine("");
                temp++;
                }
